...
- Name several sketching styles and where they might be useful.
- Describe how sketching fits into the prototyping process.
- Describe the value of quickly sketching out ideas.

# Quiz Format
1. 1 point: Try to draw it in whatever way you'd like.
1. 1 point: Use an orthographic projection style.
1. 1.5 points: Sketch the object as a combination of simple 3D solids.
1. 1.5 points: Sketch the object with 2 vanishing points.
