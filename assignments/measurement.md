# Overview
To design objects that fit with other objects, you first have to be able to measure. Calipers are one of the most common measurement tools for products that are on the scale of consumer electronics. This activity will show you how to use calipers effectively.

# Learning Objectives
By the end of this activity you will be able to:
- Measure the exterior dimensions of an object
- Measure the interior dimensions of an object
- Measure depths using calipers
...
1. .5 points: Which part of the calipers would you use to measure the depth of this cup?
    ...
    - Inside jaws
    - Step jwas
    - (Right answer) Depth gauge
1. .5 points: What happens when you try to close the jaws really hard?
    1. You generally only want to use enough force to keep the jaws flat on whatever you're measuring and no more.
1. .5 points: Most common use is measuring the outside dimensions of something.
...
1. .5 point: Use the inside jaws to measure the inside diameter of the cup

    ![Image of measuring inside of cup](assets/calipers/inner_diameter.svg)

1. .5 point: Use the step to measure the height of the cup from the outside.

    ![Image of measuring outside of cup](assets/calipers/outer_depth.svg)

1. .5 point: Use the depth gauge on the bottom to measure the depth of the cup on the inside.
